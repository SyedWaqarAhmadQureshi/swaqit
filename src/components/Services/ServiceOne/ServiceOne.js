...
const services = [
    {
        id: 1,
        title: "Intelligent Infrastructure & Network Solutions",
        link: '#',
    ...
    },
    {
        ...
        link: '#',
        description: 'SWAQ IT Data Center Solution Sets feature proven technologies, leading technology partners and innovative financing opportunities from an expert provider.',
        icon: 'fa-plus'
    }, {
        id: 3,
        title: "Hybrid Cloud",
        link: '#',
        description: 'Learn how SWAQ IT tailors hybrid cloud solutions to meet the unique business requirements presented by every organization',
        icon: 'fa-plus'
    }, {
        id: 4,
        title: "Managed Cloud Services",
        link: '#',
        description: 'Linking IT operations to business outcomes has never been more possible than in the cloud but requires the right expertise.',
        icon: 'fa-plus'
    }, {
        id: 5,
        title: "Emerging Technologies",
        link: '#',
        description: 'Removing the complexity in business transformation, leveraging a suite of flexible technology frameworks that deliver; operational efficiencies, new revenue streams, public safety, customer loyalty, and brand impact.',
        icon: 'fa-plus'
    }, {
        id: 6,
        title: "Enterprise Mobility",
        link: '#',
        description: 'Providing the required flexibility and capabilities to improve business efficiencies while also protecting corporate assets.',
        icon: 'fa-plus'
    }
];
