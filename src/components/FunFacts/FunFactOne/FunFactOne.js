...
const FunFactOne = () => {
    return (
        <section className="funfact-section mt-3 mb-3">
                    ...
                    <div className="col-lg-12">
                        <div className="fact-wrapper">
                            ...
                            {/* {
                                ...
                                <h1 className='text-white font-hire'>Why SWAQ IT Consulting ?</h1>
                                <p className='text-white text-justify font-hire-details'>
                                    As an IT networking firm, we offer unparalleled expertise and dedication to our 
                                    clients' technological needs. Our team of highly skilled professionals has a deep 
                                    understanding of the ever-changing landscape of technology and is committed to staying 
